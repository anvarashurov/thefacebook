      ...
      <div className="landing_page_signup_form">
        <form className="signup_form">
          ...
          <div className="name_container">
            <input id="first_name" type="text" name="firstName" placeholder="First name" value={this.state.first_name} onChange={this.updateFirstName} required />
            <input id="last_name" type="text" name="lastName" placeholder="Last name" value={this.state.last_name} onChange={this.updateLastName} required />
          </div>
          <div id="email">
            <input className="email" type="text" name="email" placeholder="Email" value={this.state.email_address} onChange={this.updateEmail} required />
          </div>
          <div id="password">
            <input className="password" type="password" name="password" placeholder="New password" value={this.state.password} onChange={this.updatePassword} required />
          </div>
          <label className="label_birthday" htmlFor="birthday">Birthday </label>
            <div className="birthday_container" id="birthday">
              ...
              <div className="day_container">
                ...
                <select name="birthday_day" id="day" title="Day" className="birthday_day" value={this.state.birthday["day"]} onChange={this.updateDay("day")} required>
              ...
              <select name="birthday_year" id="year" title="Year" className="birthday_year" value={this.state.birthday["year"]} onChange={this.updateYear("year")} required >
          ...
          <div className="gender_container">
            <label htmlFor="gender">
              ...
              <input type="radio" name="gender_radio" id="gender_female" onChange={this.updateGender} value="female"/>
                <span>Female</span>  
              <input type="radio" name="gender_radio" id="gender_male" onChange={this.updateGender} value="male"/>
                <span>Male</span>
              <input type="radio" name="gender_radio" id="gender_custom" onChange={this.updateGender} value="custom"/>
                <span>Custom</span>
            </label>
          </div>
          <div className="terms_and_policies_message">
            <p> By clicking Sign Up, you agree to our <a href="#">Terms, Data Policy</a> and </p>  
            <p> <a href="#"> Cookies Policy</a>. You may receive SMS Notifications from us and </p> 
            <p> can opt out any time. </p>
          </div>
